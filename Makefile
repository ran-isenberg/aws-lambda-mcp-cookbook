...
deps:
	uv export --only-group dev --format requirements-txt --no-hashes --no-emit-project --output-file dev_requirements.txt
	uv export --no-dev --format requirements-txt --no-hashes --no-emit-project --output-file lambda_requirements.txt
